...
struct background
{
  ...
  short scf_evolve_as_fluid_orig; /** set to false to only evolve KG equations, otherwise - switch to fluid when necessary. To be used in perturbation module*/
  short scf_evolve_as_fluid_new; /** set to false to only evolve KG equations, otherwise - switch to fluid when necessary. To be used in perturbation module*/
